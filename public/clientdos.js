...
function agregarTarea(tarea) {
  ...
  botonCompletado.textContent = tarea.completado ? 'Calificada' : 'Marcar como calificada'; // Define el texto del botón según el estado de la tarea
  ...
  botonCompletado.addEventListener('click', () => {
    ...
    .then(updatedTarea => {
      botonCompletado.textContent = updatedTarea.completado ? 'Calificada' : 'Marcar como calificada'; // Actualiza el texto del botón tras el cambio de estado
    })
